...
cp -f $GITHUB_WORKSPACE/configfiles/userpatches/850-regulator-fixed-check-supply-before-request-gpio.patch target/linux/generic/hack-6.6/850-regulator-fixed-check-supply-before-request-gpio.patch
